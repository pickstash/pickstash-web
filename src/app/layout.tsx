...
export default function RootLayout({
  ...
  return (
    <html lang="ko" className="h-full">
      ...
      <body className="min-h-full bg-background text-foreground antialiased xl:flex xl:h-dvh xl:items-center xl:justify-center xl:overflow-hidden xl:bg-[#e6e4db]">
        <Providers>
